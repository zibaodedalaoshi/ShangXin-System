			...
			<div class="container-fluid no-left-padding no-right-padding woocommerce-checkout">
				...
				<div class="container">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 cart-table">
						<form name="fcart" action="CheckBuyAll.jsp" method="post">
							<table class="table table-bordered table-responsive">
								...
								<tbody>
									<tr class="cart_item">
										...
										<input type="hidden" name="productID" value="<%=rs.getString(7) %>" >
										<td data-title="Product Name" class="product-name"><a href="ProductInfo.jsp?id=<%=temp%>"><%=rs.getString(2) %></a></td>
										...
										<td data-title="Quantity" class="product-quantity">
											<div class="prd-quantity" data-title="Quantity">
												<input name="quan" value="0" onfocus="if(this.value == '0') this.value =''" class="qty" type="text" autocomplete="off" >
											</div>
										</td>
										<td data-title="Total" class="product-subtotal"><a href="CheckDeleteCart.jsp?id=<%=temp%>"><i class="icon icon-Dollar"></i></a></td>
									</tr>
								  <%
		                            i++;
								}
								  ...
								  %>
									<tr>
										<td class="place-order" colspan="6">
