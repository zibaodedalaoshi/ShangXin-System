...
<body>
	...
	<%		
		...
		if(conn != null){
			String sql = "select * from user_message where ACCOUNT='"+username+"' and PASSWORD='"+ password + "'";
			...
			ResultSet rs = stmt.executeQuery(sql);			
				if(rs.next()){
					...
					//response.sendRedirect("index.jsp");
					 ...
					 out.println("<script language='javascript'>alert('登录失败！');window.location.href='Login_Signup.jsp';</script>");
